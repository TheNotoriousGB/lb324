...
class TestPasswordGenerator(unittest.TestCase):
    ...
    def test_generate_password_default_characters(self):
        ...
        password = generate_password(
            length=8, include_digits=False, include_special_chars=False
        )
    ...
    def test_generate_password_with_digits(self):
        ...
        password = generate_password(
            length=8, include_digits=True, include_special_chars=False
        )

        # Überprüfe, dass das Passwort mindestens eine Ziffer enthält
        self.assertTrue(
            any(char.isdigit() for char in password), "Password should contain digits."
        )

    def test_generate_password_with_special_chars(self):
        # Teste die Generierung von Passwörtern mit Sonderzeichen
        password = generate_password(
            length=8, include_digits=False, include_special_chars=True
        )
    ...
    def test_generate_password_with_all_options(self):
        ...
        password = generate_password(
            length=12, include_digits=True, include_special_chars=True
        )
